...
(function($) {
    ...
    $.fn.waterwheelCarousel = function (orientation, options) {
        ...
        return $(this).each(function () {
           ...
           // $('img',data.containerIDTag).live("click", function () {
            $('img',data.containerIDTag).live("hover", function () {
    ...
    $.fn.waterwheelCarousel.defaults = {
        ...
        startingItemSeparation:     80,    // the starting separation distance between each item
        itemSeparationFactor:       .7,     // determines how drastically the item separation decreases
        startingWaveSeparation:     7,      // the starting separation distance for the wave
        ...
        opacityDecreaseFactor:      .8,     // determines how drastically the item's opacity decreases
