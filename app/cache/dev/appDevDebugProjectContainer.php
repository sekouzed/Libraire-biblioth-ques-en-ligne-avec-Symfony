...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'biblio', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_f45bdad7ff3182733365c664a6a900a7');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_f45bdad7ff3182733365c664a6a900a7');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_f45bdad7ff3182733365c664a6a900a7');
        ...
        $f->setProxyDir('C:/wamp/www/projetSymfony/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'C:\\wamp\\www\\projetSymfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array(0 => 'C:\\wamp\\www\\projetSymfony\\src\\Lsi\\BiblioBundle\\Resources\\config\\validation.yml')))), NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'max_livres_on_homepage' => 5,
            'max_livres_a_la_une' => 12,
            'max_livres_populaires' => 5,
            'max_livres_recenst' => 5,
            'max_livres_on_collection' => 5,
            ...
            'validator.mapping.loader.yaml_files_loader.mapping_files' => array(
                0 => 'C:\\wamp\\www\\projetSymfony\\src\\Lsi\\BiblioBundle\\Resources\\config\\validation.yml',
            ),
